...
public class RenderUtils
{
    ...
    public void drawContinuousTexturedBox(final ResourceLocation res, final int x, final int y, final int u, final int v, final int width, final int height, final int textureWidth, final int textureHeight, final int topBorder, final int bottomBorder, final int leftBorder, final int rightBorder, final float zLevel) {
        Minecraft.getMinecraft().getTextureManager().bindTexture(res);
        this.drawContinuousTexturedBox(x, y, u, v, width, height, textureWidth, textureHeight, topBorder, bottomBorder, leftBorder, rightBorder, zLevel);
    }
    
    public void drawContinuousTexturedBox(final int x, final int y, final int u, final int v, final int width, final int height, final int textureWidth, final int textureHeight, final int topBorder, final int bottomBorder, final int leftBorder, final int rightBorder, final float zLevel) {
        ...
        for (int k = 0; k < yPasses + ((remainderHeight > 0) ? 1 : 0); ++k) {
            this.drawTexturedModalRect(x, y + topBorder + k * fillerHeight, u, v + topBorder, leftBorder, (k == yPasses) ? remainderHeight : fillerHeight, zLevel);
            this.drawTexturedModalRect(x + leftBorder + canvasWidth, y + topBorder + k * fillerHeight, u + leftBorder + fillerWidth, v + topBorder, rightBorder, (k == yPasses) ? remainderHeight : fillerHeight, zLevel);
        }
    }
